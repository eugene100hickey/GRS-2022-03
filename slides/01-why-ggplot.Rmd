...
[`r icon::fontawesome("link")` www.fizzics.ie](https://www.fizzics.ie)
[`r icon::fontawesome("twitter")` @eugene100hickey](https://twitter.com/eugene100hickey)
[`r icon::icon_style(icon::fontawesome("github"), scale = 1)` eugene100hickey](https://github.com/eugene100hickey)
...
.pull-right-wide[
[Giovanna Rampazzo](https://www.tudublin.ie/research/postgraduate-research/graduate-research-school/meet-the-team/), co-pilot for this workshop and administrator of the Graduate Research School.
]
...
.pull-left-narrow[.center[
`r icon::icon_style(icon::fontawesome("smile"), scale = 3, fill = "#e5bf00")`]]
